  ...
  async function handleRunAgent() {
    ...
    try {
      ...
      if (err instanceof ApiError && err.notImplemented) {
        setRunError(
          "Running the agent from the dashboard isn't wired up on the backend yet (POST /api/ai/ideas/run). Ideas generated by the scheduled batch job still show up below."
        )
      } else {
